...
public class FactoryAPICommand {
    ...
    public record UIDefinitionPayload(Optional<net.minecraft.resources.Identifier> defaultScreen, CompoundTag uiDefinitionNbt) implements CommonNetwork.Payload {
